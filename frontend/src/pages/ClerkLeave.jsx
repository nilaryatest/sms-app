...
export default function ClerkLeave() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <header>
                <h1 className="text-3xl font-black text-gray-900 tracking-tight">Clerk Leave Requests</h1>
                <p className="text-gray-500 mt-1 font-medium">Apply for sick leaves or vacation tracking.</p>
            </header>
